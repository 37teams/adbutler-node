...
var AdButler = function(params) {
  ...
  this.adItems = require('./resources/Banners')(this)
  this.adItems.customHTML = require('./resources/CustomHTMLBanners')(this)
  this.adItems.customHTML.conversionTag = require('./resources/CustomHTMLBannerConvTag')(
    this
  )
  this.adItems.flash = require('./resources/FlashBanners')(this)
  this.adItems.flash.conversionTag = require('./resources/FlashBannerConvTag')(
    this
  )
  this.adItems.images = require('./resources/ImageBanners')(this)
  this.adItems.images.conversionTag = require('./resources/ImageBannerConvTag')(
    this
  )
  this.adItems.richMedia = require('./resources/RichMediaBanners')(this)
  this.adItems.richMedia.conversionTag = require('./resources/RichMediaBannerConvTag')(
    this
  )
  ...
  this.campaigns.standard = require('./resources/BannerCampaigns')(this)
  this.campaigns.standard.conversionTag = require('./resources/BannerCampaignConvTag')(
    this
  )
  this.campaigns.textAds = require('./resources/TextAdCampaigns')(this)
  this.campaigns.textAds.conversionTag = require('./resources/TextAdCampaignConvTag')(
    this
  )
  ...
  this.zones.standard = require('./resources/BannerZones')(this)
  this.zones.standard.conversionTag = require('./resources/BannerZoneConvTag')(
    this
  )
  this.zones.emails = require('./resources/EmailZones')(this)
  this.zones.emails.conversionTag = require('./resources/EmailZoneConvTag')(
    this
  )
  this.zones.textAds = require('./resources/TextAdZones')(this)
  this.zones.textAds.conversionTag = require('./resources/TextAdZoneConvTag')(
    this
  )

  this.vastBanners = require('./resources/VASTBanners')(this)
  this.vastBanners.conversionTag = require('./resources/VASTBannerConvTag')(
    this
  )
  this.vastCampaignAssignments = require('./resources/VASTCampaignAssignments')(
    this
  )
  this.vastCampaigns = require('./resources/VASTCampaigns')(this)
  this.vastCampaigns.conversionTag = require('./resources/VASTCampaignConvTag')(
    this
  )
  this.vastChannels = require('./resources/VASTChannels')(this)
  this.vastChannelZoneAssignments = require('./resources/VASTChannelZoneAssignments')(
    this
  )
  ...
  this.vastPlacements.conversionTag = require('./resources/VASTPlacementConvTag')(
    this
  )
